...
<div class="item_drop_wrapper">
	...
	<SubItemInteraction @close_interaction="close_sub_item_interaction" @set_password="set_password" @unlock_password="unlock_password" @make_admin="make_admin" @unmake_admin="unmake_admin" @kick_member="kick_member" @stop_user_display="stop_displaying_user" @go_to_pong_match="(param) => {console.log(param); $emit('go_to_pong_match', param)}" @unlock_padlock="unlock_padlock" :interaction="this.active_interaction" :item="this.item" :userId="userId"/>
</div>
